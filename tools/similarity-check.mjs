...
const RUBRIC = [
  ...
  ["画面", "精致 3D 车模(金属漆/镀铬/轮辐/大灯/尾灯)+头盔车手", 5, () => P(S([/buildKartMesh/, /kartMats/, /envCube/, /helmet/, /steerVis/]), 0.9, "原创造型规避版权素材")],
  ["画面", "氮气变形卡丁车(尾翼展开/涡轮核心/能量光效)", 4, () => B("氮气变形触发(车体机构展开)")],
  ["画面", "霓虹漂移/氮气拖尾光带", 2, () => B("霓虹漂移拖尾生成")],
  ["系统", "车库 360° 车模展示(换色/变形演示)", 2, () => B("车库展示模式可进入")],
  ["画面", "多主题赛道(村庄/雪谷/沙城)", 4, () => {
